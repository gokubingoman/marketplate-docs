...
flowchart TB
    subgraph Creators
        C1[Trust → credibility & conversion]
        C2[Software → time saved & scale]
        C3[Community → discovery & retention]
        C4[Economics → sustainable margin]
    end
    subgraph Customers
        U1[Trust → confidence to buy]
        U2[Software → seamless experience]
        U3[Community → connection to local makers]
        U4[Economics → fair value for quality]
    end
    subgraph Platform
        P1[Trust → defensible moat]
        P2[Software → retention & expansion]
        P3[Community → organic growth]
        P4[Economics → unit economics]
    end
```
